...
const footerLinks = {
    top1: [
        ...
        { id: 1, text: 'About us', action: 'popup', payload: 'work-in-progress', decoration: 'underline' },
        { id: 2, text: 'Comet Global', action: 'popup', payload: 'work-in-progress', decoration: 'underline' },
        { id: 3, text: 'Work with us', action: 'popup', payload: 'work-in-progress', decoration: 'underline' }
    ],
    top2: [
        ...
        { id: 4, text: 'Help', action: 'popup', payload: 'work-in-progress', decoration: 'underline' },
        { id: 5, text: 'FAQs & info', action: 'popup', payload: 'work-in-progress', decoration: 'underline' },
        { id: 6, text: 'Contact', action: 'popup', payload: 'work-in-progress', decoration: 'underline' }
    ],
    bottom: [
        ...
        { id: 14, text: 'Website terms of use', action: 'popup', payload: 'work-in-progress', decoration: null },
        { id: 15, text: 'Cookie policy', action: 'popup', payload: 'work-in-progress', decoration: null },
        { id: 16, text: 'Privacy policy', action: 'popup', payload: 'work-in-progress', decoration: null }
    ]
}
