...
import UnprotectedComponent from '../UnprotectedComponent';
...
import { menuLinks, loggedAsideLinks } from '../../data/internal-links';
...
function Header() {
    ...
    function openAside(side) {
        const content = side === 'left' ? <AsideMenuLeft links={menuLinks} /> : <AsideMenuRight links={loggedAsideLinks} />;
    ...
    return (
        <header className="header" data-transparency={transparency} >
            <section className="header__main">
                <button className="header__icon element--clickable" onClick={() => openAside('left')}>
                ...
                />
                <ProtectedComponent>
                    <button className="header__icon element--clickable" onClick={() => openAside('right')}>
                        <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <UnprotectedComponent>
                    <Button action={() => handlePopupLaunch({ modalClass: 'large', content: 'login' })} text={'log in'} />
                </UnprotectedComponent>
            </section>
